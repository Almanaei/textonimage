  ...
  return (
    <div className="w-full max-w-sm mx-auto flex flex-col gap-4" dir="rtl">
      ...
      <button
        ...
        className="flex items-center justify-center gap-2 w-full rounded-xl bg-white/10 backdrop-blur-xl border border-white/20 py-4 text-base font-bold text-white shadow-lg transition active:scale-95 hover:bg-white/20 font-arabic"
      >
      ...
      {/* Share row — dark glass */}
      <div className="flex gap-3">
        <button
          onClick={handleShare}
          className="flex flex-1 items-center justify-center gap-2 rounded-xl bg-white/10 backdrop-blur-xl border border-white/20 py-4 text-base font-bold text-white shadow-lg transition active:scale-95 hover:bg-white/20 font-arabic"
        >
          {shareStatus === "copied" ? (
            <>
